...
namespace Saturn
{
    ...
    public static unsafe class ImGuiRaylibPlatform
    {
        ...
        public static bool Init()
        {
            ...
            byte[] UTF8Data = System.Text.Encoding.Default.GetBytes("imgui_impl_raylib");

            byte* ptr;
            ptr = (byte*)Marshal.AllocHGlobal((int)UTF8Data.Length);
            Marshal.Copy(UTF8Data, 0, (IntPtr)ptr, UTF8Data.Length);

            io.BackendPlatformName = ptr; //.ToUTF8Ptr();
